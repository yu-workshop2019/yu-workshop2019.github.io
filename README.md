...
<u><b> 
このWebサイトは、山口大学工学部で2019年度に開催されたワークショップのための教材としてつくられたものです。  
2019年度のワークショップは終了しました。  
このWebサイトの情報は2019年4月時点のものです。また、その後メンテナンス（加筆修正）されていないため、
使用しているソフトウェアのバージョンアップなどの要因によっては、最新の状況とは適合しない可能性があります。  
</b></u>
