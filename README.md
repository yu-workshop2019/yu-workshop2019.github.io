...
<b><font color="red">重要：7月3日（水）は、17:40から志道場の利用方法についての講習会が開かれるため、山口大学工学部ワークショップはお休みします。</font></b>

<u><b>次回のワークショップ（第11回目）は、7月10日（水）17:50～19:00 です。</b></u>

※16:10から会場は開いているので、17:50以前から来て自分で進めていただいても構いません。

解説資料は[https://yu-workshop2019.github.io/manual](/manual.html)です。

時間外にもやりたい、物品を借りたいなど、要望・相談・その他疑問などは、本ページ下部のEメールアドレスまでご連絡ください。
...
基本的なハンドツールや、ボール盤などの電動工具がそろっています。

3Dプリンタやレーザ加工機など、最新のデジタル工機械を利用することもできます。
...
- 参加を希望される方は、ワークショップが開催される毎週水曜日の17：50 に上記の場所までお越しください。
